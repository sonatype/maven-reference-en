...
----
/usr/local % cd /opt
/usr/local % ln -s apache-maven-3.2.5 maven
/usr/local % export PATH=/opt/maven/bin:${PATH}
----
...
'/opt/maven-2.future'. Since, you've already set your +M2_HOME+
...
==== Upgrading from Maven 1.x to Maven 3.x

If you are upgrading from Maven 1 to Maven 3, you are going to be
