...
the same scope of the direct dependency . Transitive dependencies which 
are runtime scoped will
...
is runtime scoped and the direct dependency is compile scoped, 
